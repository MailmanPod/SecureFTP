...
public class SimpleList<E extends Comparable> implements Serializable {
    ...
    /**
     * Metodo que inserta un objeto segun el index que se pasa como parametro en la
     * lista simple.
     * @param index la posicion donde se insertara el nuevo objeto.
     * @param x el nuevo objeto a insertar
     * @throws ListPointerOutOfBoundsException si el indice es negativo o es mayor
     * al largo actual de la lista.
     */
     ...
     * se encuentra en la lista simple.
     * @param x elemento a buscar en la lista.
     * @return true si encontro el objeto en la lista. <br>
    ...
    /**
     * Metodo que tiene como objetivo retornar un objeto que esta en la lista segun
     * un indice que se pasa como parametro.
     * @param index con la posicion donde posiblemente se encuentre el objeto.
     * @return el objeto encontrado.
     * @throws ListPointerOutOfBoundsException si el inidice esta fuera del rango o
     * cuando el puntero se "cayo de la lista".
     */
    @SuppressWarnings("empty-statement")
     ...
     * indice pasado como parametro es negativo, o si el indice es mayor al tamanio
     * de la lista.
     */
    @SuppressWarnings("empty-statement")
     ...
     * @return E si el objeto se encuentra en la lista. <br>
    ...
    /**
     * Metodo que tiene como objetivo reemplazar el elemento ubicado en el nodo numero
     * index, por el elemento x.
     * @param index indice o posicion del objeto a reemplazar.
     * @param x nuevo objeto.
     * @return el objeto antiguo (el que se encontraba antes de ser reemplazado).
     ...
     * @return int que es el indice de la primera ocurrencia. <br>
     * -1 en caso contrario
    ...
    /**
     * Metodo que tiene como objetivo crear un arreglo que contiene todos los elementos
     * que se encuentran en la lista.
     * @param clase representa al tipo de elementos que contendra el arreglo. En
     * otras palabras, indicamos de que clase son los objetos que contiene la lista.
     ...
     * @return SimpleList<E> con la representacion de todos los objetos contenidos
     * en el arreglo.
     */
    ...
    private class Iterador implements LocalIterator<E> {
        ...
        /**
         * Atributo que representa un puntero al nodo actual, al cual se esta visitando.
         */
         ...
         * @return true si hay elementos. <br>
