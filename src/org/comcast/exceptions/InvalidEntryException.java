 ...
 * Esta excepcion se lanza en situaciones en donde se quiere ingresar a una entrada
 * no valida en la tabla de hash, o se quiere eliminar o buscar una entrada que
 * no existe.
